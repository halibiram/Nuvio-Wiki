...
>
> Not all Nuvio versions support plugins. Due to platform store rule, the Nuvio versions downloaded from an app store do not support Plugins. Only the sideloaded versions support plugins.
