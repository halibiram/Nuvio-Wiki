# Android Mobiel Installatie [Android Mobile Only]
...
2.  **Onbekende bronnen inschakelen:**
    - Ga naar **Instellingen** > **Apps** > **Onbekende apps installeren**.
    - Kies je browser of bestandsbeheerder en schakel **Toestaan van deze bron** in.
3.  **Installeren:** Open de gedownloade APK en tik op **Installeren**.
4.  **Eerste start:** Open Nuvio. Mogelijk wordt er gevraagd om opslagrechten te verlenen en om Nuvio toe te staan onbekende apps te installeren. Dit is nodig zodat Nuvio zichzelf kan updaten.
