...
### Trakt-configuratie
1. Navigeer naar **Instellingen** > **Trakt** en klik op **Connect Trakt**.
2. Voltooi de externe authenticatie en keer daarna terug naar het Trakt-instellingenscherm in Nuvio.
3. Selecteer je gewenste **Library Source**.
4. Stel de opties in voor het bijhouden van je kijkvoortgang. Je kunt synchroniseren tussen Trakt of Nuvio, maar het selecteren van **Nuvio Sync** wordt ten zeerste aanbevolen voor de meest nauwkeurige kijkvoortgang.

> [!NOTE]
> Als je Nuvio Sync selecteert, kan Trakt nog steeds je kijkvoortgang synchroniseren.
...
**Meer hulp nodig?** Duik in de [Volledige documentatie](/nl/settings/).
